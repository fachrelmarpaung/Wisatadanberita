...
.p-video-title span{}
          ...
          <div class="col-lg-8">
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div class="flex-grow-1 ms-3">
                <h6 class="mb-0">
                  <span class="link link-dark"><?= @$ViewArtikel['postby']; ?></span>
                </h6>
            ...
            <div class="mb-6">
              <h1 class="h2"><?= @$ViewArtikel['Title']; ?></h1>
              <div class="position-relative">
            <div class="position-relative">
              <img class="img-fluid" src="../assets/artikel/<?= @$ViewArtikel['Gambar']; ?>" alt="Image Description">
            </div>
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <span class="avatar avatar-sm avatar-circle">
                    <img class="avatar-img" src="../assets/job/icon-map-pin.svg" alt="Image Description">
                  </span>
                </div>
                <div class="flex-grow-1 ms-2">
                  <div class="fs-5 fw-bold mb-0">Lokasi</div>
                  <span class="d-block fs-6"><a href="<?= @$ViewArtikel['linkgmaps']; ?>"><?= @$ViewArtikel['NamaTempat']; ?> <i class="bi bi-box-arrow-up-right"></i></a></span>
                </div>
              </div>
            </div>
            <!-- End Media -->
            <!-- End Media -->
                ...
                <!-- End Row -->
              <p class=""><?= @$ViewArtikel['Deskripsi']; ?></p>
              <p></p>
            </div>
          </div>
  ...
  <script>
    ...
    var map = L.map('map').setView([<?= $ViewArtikel['Longitude']; ?>, <?= $ViewArtikel['Latitude']; ?>], 13); // Set initial center and zoom level
